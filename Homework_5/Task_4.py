# Задача 4:
#
# Создать программу для игры с конфетами человек против человека.
# Условие задачи:
#
...
#
# Добавить игру против бота
# Подумать как наделить бота "интеллектом"
...
while CANDIES > 0:
    print(f"There are {CANDIES} sweet on the table, you can take [1 .. {CANDIES_LIMIT}]")
